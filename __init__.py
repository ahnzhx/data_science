...
# print(mc_df[mc_df.shoe_size==38])
# mc_df.at[37313, 'shoe_size'] = None
# print(mc_df.sort_values(by=['bra_size'], ascending=False).head(10))
...
# print(mc_df[mc_df.cup_size.isnull()].sample(20))
...
# print(mc_df[mc_df.height.isnull()].head(20))
